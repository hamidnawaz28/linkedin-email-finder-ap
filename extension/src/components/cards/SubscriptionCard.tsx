...
const SubscriptionCard = () => {
    ...
    const plans = [{
        planName: 'Trial', price: 0, tagline: 'Upto 10 emails only', disable: trialOver
    }, {
        planName: 'Premium', price: 10, tagline: 'Unlimited emails', disable: false
    }]
    ...
    return (
        <Box>
            ...
            <Button variant='contained' color='primary' sx={{ width: '100%', margin: '40px 0px' }} disabled={selectedPlan == ''} onClick={onProceedHandle}>Proceed</Button>
        </Box >
    )
}
